...
try:
    ...
    class API(object):
        ...
        def clearLogs(self):
            ...
            #Clear Transmit Log
            log = open("public/transmitLog.csv","w")
            log.write("Date and Time,Command String Passed\n")
            log.close()

            #Clear Receive Log
            log = open("public/receiveLog.csv","w")
            log.write("Date and Time,Arduino Response\n")
            log.close()
        ...
        def send(self,command="this"):
            ...
            try:
                ...
                with open ("public/transmitLog.csv", "a+") as log:
            ...
            while self.connected == True:
                ...
                try:
                    if self.serial.in_waiting > 0:
                        ...
                        with open ("public/receiveLog.csv", "a+") as log:
                            log.write(logLine+"\n")
        ...
        def connect(self):
            ...
            currentDateTime = time.strftime("%d/%m/%Y %H:%M:%S")
            status = currentDateTime + " - INFO: Arduino already connected."
